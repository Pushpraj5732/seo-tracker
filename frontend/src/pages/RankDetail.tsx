...
export default function RankDetail() {
        ...
        try {
            ...
            if (res.data.success) {
                if (res.data.tracking.status === "checking") {
                    ...
                    return; // keep loading true while checking, or if you want to show it, you'd need to set tracking too.
                }
    ...
    const handleRefresh = async () => {
        ...
        setRefreshing(true);
        try {
            await api.post(`api/rank/${tracking._id}/refresh`); // <--- fixed extra }
