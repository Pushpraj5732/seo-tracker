...
const compitetorSchema=new mongoose.Schema({
    position:{type:Number,default:null},
...
const keyWordTrackingSchema=new mongoose.Schema({
    ...
    keyword:{type:String,trim:true,required:true,lowercase:true},
    url:{type:String,trim:true,required:true},
    domain:{type:String,required:true},
    currentPosition:{type:Number,default:null},
    currentPage:{type:Number,default:null},
    bestPosition:{type:Number,default:null},
    positoinChange:{type:Number,default:0},
    rankHistory:[rankEntrySchema],
    competitors:[compitetorSchema],
    active:{type:Boolean,default:true},
    lastChecked:{type:Date,default:null},
    status:{
         type: String,
        enum: ["pending", "checking","completed","failed"],default: "pending"},
},{timestamps:true})
